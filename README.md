...
* **Python 3.11 or newer** (uses modern type-hint syntax such as `dict[str, Any]` and `str | None`). Tested through Python 3.15.
* Dependencies (installed automatically): [`compatibility`](https://github.com/RuedigerVoigt/compatibility) `>= 2.3.0, < 3` and [`userprovided`](https://github.com/RuedigerVoigt/userprovided) `>= 3.0.0, < 4`.

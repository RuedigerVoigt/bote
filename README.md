...
* Dependencies (installed automatically): [`compatibility`](https://github.com/RuedigerVoigt/compatibility) `>= 2.3.0, < 3` and [`userprovided`](https://github.com/RuedigerVoigt/userprovided) `>= 2.5.0`.
